import { j as attr, i as bind_props, b as pop, p as push } from './index.js';
function NameControl($$payload, $$props) {
  push();
  let { formData = void 0 } = $$props;
  $$payload.out += `<div class="grid gap-4 lg:grid-cols-2"><div><label>First Name <br> <input type="text"${attr('value', formData.name.first, false)}></label></div> <div><label>Last Name <br> <input type="text"${attr('value', formData.name.last, false)}></label></div></div>`;
...
export { NameControl as N, githubDark as g };
