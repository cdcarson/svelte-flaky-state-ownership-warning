import { G as lt, ab as le } from './runtime.B7m_t_lM.js';
...
const he = ['href', 'pathname', 'search', 'toString', 'toJSON'];
function pe(t, n, e) {
  const r = new URL(t);
...
function ve(t, n) {
  ...
  if (r != null && r.textContent) {
    ...
    return (
      ...
      r.getAttribute('data-b64') !== null && (a = we(a)),
...
function Ae(t) {
  return t.slice(1).split('/').filter(Se);
}
function Re(t, n, e) {
  const r = {},
    a = t.slice(1),
...
function Ie({ nodes: t, server_loads: n, dictionary: e, matchers: r }) {
  const a = new Set(n);
  return Object.entries(e).map(([s, [c, l, u]]) => {
    const { pattern: h, params: g } = ke(s),
      d = {
        id: s,
        exec: (_) => {
          const f = h.exec(_);
          if (f) return Re(f, g, r);
        },
...
var Dt;
const P =
  ((Dt = globalThis.__sveltekit_qwhc4y) == null ? void 0 : Dt.base) ?? '';
var Ct;
const Pe =
    ((Ct = globalThis.__sveltekit_qwhc4y) == null ? void 0 : Ct.assets) ?? P,
  Te = '1714848149804',
...
async function nt({
  ...
  (t.pathname = fe(t.pathname, s)), (t.search = t.search);
  const c = {
    type: 'loaded',
